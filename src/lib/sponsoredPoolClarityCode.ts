export const getSponsoredClarityCode = (poolSize: number, deployer: string) => {
	return `
;; ==============================
;; Stacks Wars - Sponsored Pool Contract (Same Interface)
;; ==============================
;; author: flames.stx
...
(define-constant POOL_SIZE u${poolSize}000000) ;; Pool funding amount in microSTX
